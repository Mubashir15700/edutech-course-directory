...
router.post("/", protect, adminOnly, validate(createCourseSchema), asyncHandler(createCourse));
router.put("/:id", protect, adminOnly, validate(updateCourseSchema), asyncHandler(updateCourse));
